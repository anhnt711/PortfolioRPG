...
import { Mail, Sparkles, User, FolderGit2 } from "lucide-react";
...
const cards = [
  {
    key: "1",
    title: "Information",
    description: "Profile, motto, and overview.",
    icon: User,
    href: "#intro",
  },
  {
    key: "2",
    title: "Skills Tree",
    description: "Explore skills as a constellation map.",
    icon: Sparkles,
    href: "#skills",
  },
  {
    key: "3",
    title: "Projects",
    description: "Missions and builds completed.",
    icon: FolderGit2,
    href: "#projects",
  },
  {
    key: "4",
    title: "Contact",
    description: "Send a quest scroll.",
    icon: Mail,
    href: "#contact",
  },
];
    ...
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-b from-[#120c0a] via-[#130e1a] to-[#0c0a0f] text-amber-100 flex items-center">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 py-10 md:py-14 flex flex-col gap-10">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-amber-100/80 text-sm md:text-base">Where do you want to start your journey?</p>
        </div>
        ...
        <div className="space-y-4 text-center">
          ...
          <div className="text-[11px] text-amber-100/60">(c) Nguyen Tien Anh - Code Disciple</div>
        </div>
      </div>
    </section>
  );
